...
##### SORT
> 1181(단어 정렬) 1427(소트인사이드) 2693(N번째 큰 수) 2750(수 정렬하기) 2751(수 정렬하기 2) 2752(세수정렬) 3273(두 수의 합) 10814(나이순 정렬) 10867(중복 빼고 정렬하기) 11650(좌표 정렬하기) 16435(스네이크버드)
##### GREEDY
> 1343(폴리오미노) 1541(잃어버린 괄호) 2839(설탕 배달) 11047(동전 0) 11399(ATM) 13305(주유소)
##### QUEUE_STACK_GRAPH
